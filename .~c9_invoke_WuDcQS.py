        ...
        if request.form['action'] == 'Submit':
            ...
            for type in TYPES:
                ...
                if results[0]["envelope"] == 0:
                    db.execute("UPDATE a1 SET envelope = :enveloperesults WHERE type=:type", enveloperesults=results[0], type=type)
                if results[0].we == 0:
                    db.execute("UPDATE a1 SET weight=:weightresults WHERE type=:type", weightresults=results[0].weight, type=type)

            """db.execute("UPDATE a1 (envelope, weight) VALUES (:acornenvelope, :acornweight), (:fruitsenvelope, :fruitsweight), (:twigsenvelope, :twigsweight), (:unknownenvelope, :unknownweight), (:ashenvelope, :ashweight), (:beechenvelope, :beechweight), (:birchenvelope, :birchweight), (:cherryenvelope, :cherryweight), (:chestnutenvelope, :chestnutweight), (:hemlockenvelope, :hemlockweight), (:oakenvelope, :oakweight), (:nontreelitterenvelope, :nontreelitterweight), (:pineconesenvelope, :pineconesweight), (:rmapleenvelope, :rmapleweight), (:rpineenvelope, :rpineweight), (:spruceenvelope, :spruceweight), (:strmapleenvelope, :strmapleweight), (:whazelenvelope, :whazelweight), (:wpineenvelope, :wpineweight) WHERE envelope = 0 OR weight = 0", **params)"""
            return redirect("/A1")
    else:
...
def A2():
    if request.method == "POST":
        ...
        db.execute("INSERT INTO a2 (type, envelope,weight, userid) VALUES ('acorn', :acornenvelope, :acornweight, :userid), ('fruits', :fruitsenvelope, :fruitsweight, :userid), ('twigs', :twigsenvelope, :twigsweight, :userid), ('unknown', :unknownenvelope, :unknownweight, :userid), ('ash', :ashenvelope, :ashweight, :userid), ('beech', :beechenvelope, :beechweight, :userid), ('birch', :birchenvelope, :birchweight, :userid), ('cherry', :cherryenvelope, :cherryweight, :userid), ('chestnut', :chestnutenvelope, :chestnutweight, :userid), ('hemlock', :hemlockenvelope, :hemlockweight, :userid), ('oak', :oakenvelope, :oakweight, :userid), ('nontreelitter', :nontreelitterenvelope, :nontreelitterweight, :userid), ('pinecones', :pineconesenvelope, :pineconesweight, :userid), ('rmaple', :rmapleenvelope, :rmapleweight, :userid), ('rpine', :rpineenvelope, :rpineweight, :userid), ('spruce', :spruceenvelope, :spruceweight, :userid), ('strmaple', :strmapleenvelope, :strmapleweight, :userid), ('whazel', :whazelenvelope, :whazelweight, :userid), ('wpine', :wpineenvelope, :wpineweight, :userid) ON CONFLICT (type) DO UPDATE SET envelope=excluded.envelope, weight=excluded.weight", **params)
        return redirect("/A2")
    else:
...
def A3():
    if request.method == "POST":
        ...
        repopulate = db.execute("SELECT * from a3")
        return redirect("/A3")
    else:
